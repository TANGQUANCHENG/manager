...
(function() {
  ...
  var propertyKeywords = keySet([
    ...
    "fonts-family", "fonts-kerning", "fonts-language-override", "font-size", "fonts-size-adjust",
    "fonts-stretch", "fonts-style", "fonts-synthesis", "fonts-variant",
    ...
    "fonts-weight", "grid-cell", "grid-column", "grid-column-align",
