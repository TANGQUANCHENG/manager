var App = function () {
          ...
          pie: {
            ...
            label: {
                        ...
                        formatter: function (label, series) {
                            return '<div style="fonts-size:12px;text-align:center;padding:2px;color:#333;">' + label + '</div>';
  ...
  return {
    ...
    init: function (options) {
      ...
      var offset = 220;
      var duration = 500;
      var button = $('<a href="javascript:void(0)" class="back-to-top"><i class="fa fa-angle-up"></i></a>');
